    ...
    companion object {
        ...
        fun provideTestData(): Stream<Arguments> =
            Stream.of(
                ...
                Arguments.of("52 -p 0.1 -c -t", true, """{ "d": "80658175170943878571660636856403766975289505440883277824000000000000 (≈8*10^67)", "p": "10%", "results": { "taylor": { "result": "4122665867622533660736208120290868 (≈4*10^33)" } } }"""),
                Arguments.of("52 -p 0.5 -c -t", true, """{ "d": "80658175170943878571660636856403766975289505440883277824000000000000 (≈8*10^67)", "p": "50%", "results": { "taylor": { "result": "10574307231100289363611308602026252 (≈10^34)" } } }"""),
                Arguments.of(
